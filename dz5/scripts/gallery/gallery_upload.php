    ...
    if (getCurrentUser() !== null) {
        if (isset($_FILES['file_name'])) {
            ...
            if ((0 === $file_error) && (('image/png' === $file_type) || (('image/jpeg' === $file_type)))) {
                ...
                $file = fopen(__DIR__ . '/../../data/log/in_gallery_upload.txt', 'a');
                fwrite($file, getCurrentUser()) . fwrite($file, date('d.m.Y H:i:s', time())) . fwrite($file, $file_original_name);
                fclose($file);
                ...
                echo 'Вы успешно загрузили фото!';
        ...
        echo 'Для загрузки фото, необходимо залогиниться!';
    }